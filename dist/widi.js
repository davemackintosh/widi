...
var MIDIDevice = (function () {
  function MIDIDevice(device, busDevice) {
    _classCallCheck(this, MIDIDevice);

    this.ID = "";
    this.NAME = "Midi Device";
    this.MANUFACTURER = "Generic";
    this.TUNING = 440;
    this.CONNECTED = true;
    this.BUS_TARGET = null;
  ...
  _createClass(MIDIDevice, [{
    key: "reactToDeviceStageChanging",
    value: function reactToDeviceStageChanging(midiConnectionEvent) {
      var _this = this;
      ...
      if (this.BUS_TARGET) {
        this.BUS_TARGET.events.deviceChange.forEach(function (callback) {
    ...
    key: "reactToMidiMessage",
    value: function reactToMidiMessage(midiMessage) {
      var _this2 = this;

      // Get the data from the message.

      var _midiMessage$data = _slicedToArray(midiMessage.data, 3);

      var command = _midiMessage$data[0];
      var note = _midiMessage$data[1];
      var velocity = _midiMessage$data[2];
      ...
      if (this.BUS_TARGET) {
        this.BUS_TARGET.events.midiMessage.forEach(function (callback) {
          return callback.call(_this2, { command: command, note: note, velocity: velocity });
        });
      } else {
        console.warn("Midi message received for \"" + this.NAME + "\" but no bus to send message to.");
      }
...
},{"./$":42,"./$.an-object":4,"./$.global":26}],51:[function(require,module,exports){
'use strict';
...
},{"./$":42,"./$.a-function":3,"./$.an-object":4,"./$.core":14,"./$.def":16,"./$.fails":21,"./$.is-object":34}],135:[function(require,module,exports){
...
},{"./$":42,"./$.an-object":4,"./$.def":16,"./$.enum-keys":19,"./$.fails":21,"./$.get-names":25,"./$.global":26,"./$.has":27,"./$.keyof":43,"./$.library":44,"./$.property-desc":53,"./$.redef":54,"./$.shared":58,"./$.support-desc":67,"./$.tag":68,"./$.to-iobject":72,"./$.uid":75,"./$.wks":77}],164:[function(require,module,exports){
'use strict';
var $            = require('./$')
...
},{"./lib/polyfill":2}],185:[function(require,module,exports){
...
},{}],"Widi":[function(require,module,exports){
/* eslint-disable */
...
var _ = _interopRequireWildcard(_babelPolyfill);
...
var Widi = (function () {
  ...
  _createDecoratedClass(Widi, [{
    key: "SYSEX",
    decorators: [utils.nonenumerable.bind(utils)],
    ...
    key: "events",
    decorators: [utils.readonly.bind(utils), utils.nonenumerable.bind(utils)],
    initializer: function initializer() {
  ...
  function Widi() {
    ...
    _classCallCheck(this, Widi);

    this.Inputs = [];

    _defineDecoratedPropertyDescriptor(this, "SYSEX", _instanceInitializers);

    _defineDecoratedPropertyDescriptor(this, "events", _instanceInitializers);

    // Get the available midi devices.
    navigator.requestMIDIAccess({ sysex: this.SYSEX }).then(function (midiAccessInterface) {
      return _this.getInputsAndInterfaceFromPromise(midiAccessInterface);
    });
  }
  ...
  _createDecoratedClass(Widi, [{
    key: "getInputsAndInterfaceFromPromise",
    value: function getInputsAndInterfaceFromPromise(midiAccessInterface) {
      // Get an array of the available inputs.
      this.Inputs = [].concat(_toConsumableArray(midiAccessInterface.inputs.values())).map(this.NewMIDIDevice.bind(this));
    ...
    key: "NewMIDIDevice",
    value: function NewMIDIDevice(device) {
      return new _device2["default"](device, this);
    }
